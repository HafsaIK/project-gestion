    ...
    <div class="box-container">
        ...
        <div class="transaction-box">
            ...
            <div class="item">
                ...
                <div class="value">{{$fullPaymentInfo->employer->nom}} {{$fullPaymentInfo->employer->prenom}}</div>
            </div>
            <div class="item">
                <div class="label">email:</div>
                <div class="value">{{$fullPaymentInfo->employer->email}}</div>
            </div>
            <div class="item">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{$fullPaymentInfo->amount}} DH</td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div class="single_item"> <span>Total</span>
                                        <span class="value">Montant du paiement -DH</span>
                                    </div>
                                </td>
                            </tr>
