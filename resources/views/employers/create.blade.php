...
<div class="row g-4 settings-section">
    <div class="col-12 col-md-4">
        ...
        <div class="section-intro">Ajouter ici un nouvel employeur.</div>
    </div>
...
<circle cx="8" cy="4.5" r="1"/>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="setting-input-2" placeholder="Entrer le prenom" name="last_name" required>
                    </div>
                    <div class="mb-3">
                        <label for="setting-input-3" class="form-label">Email</label>
                        <input type="email" class="form-control" id="setting-input-3" name="email" placeholder="Email">
                    </div>
                    <div class="mb-3">
                        <label for="setting-input-3" class="form-label">Contact</label>
                        <input type="text" class="form-control" id="setting-input-3" name="phone" placeholder="Entrer le mail">
                    </div>
