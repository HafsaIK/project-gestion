...
<div class="row g-4 settings-section">
    <div class="col-12 col-md-4">
        ...
        <div class="section-intro">Ajouter ici un nouvelle configuration.</div>
    </div>
                ...
                <form class="settings-form" method="POST" action="{{route('configurations.store')}}">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="type" id="type" class="form-control">
                            ...
                            <option value="DEVELOPPER_NAME">Equipe de devloppement</option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="setting-input-1" placeholder="Entrer la valeur de la configuration" name="value"  value="{{old('value')}}" required>
                        @error('value')
                            <div class="text-danger">{{$message}}</div>
                        @enderror
                    </div>
